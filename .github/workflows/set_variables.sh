...
echo "::set-output name=buildlog_dir::/pub/metwork/${CI}/buildlogs/${B}/mfextaddon_radartools/centos6/${GITHUB_RUN_NUMBER}"

echo "::set-output name=rpm_dir::/private/metwork_addons/${CI}/rpms/${B}/centos6"
echo "::set-output name=doc_dir::/private/metwork_addons/${CI}/docs/${B}/mfextaddon_radartools"
