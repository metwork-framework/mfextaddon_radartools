...
`MFEXTADDON_RADARTOOLS_HOME` | alias of `MFMODULE_HOME` if the current loaded metwork module is `mfextaddon_radartools` | `/opt/metwork-mfserv-0.8`
`MFEXTADDON_RADARTOOLS_VERSION` | alias of `MFMODULE_VERSION` if the current loaded metwork module is `mfextaddon_radartools` | `0.9.4`, `integration.ci1036.1949d86`
